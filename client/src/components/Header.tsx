      ...
      <div className="max-w-6xl mx-auto flex items-center justify-between">
        <div className="flex items-center gap-2 lg:gap-3">
          ...
          <div>
            ...
            <p className="text-[11px] lg:text-xs font-mono-data text-muted-foreground uppercase tracking-widest leading-none mt-0.5">detecting insider trades on betting markets</p>
          </div>
        </div>
